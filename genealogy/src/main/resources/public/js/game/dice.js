...
document.querySelector('.btn-roll').addEventListener('click', function() {
    if(gamePlaying) {
        ...
        document.getElementById('dice-2').src = '/image/game/dice-' + dice2 + '.png';

        //3. Update the round score IF the rolled number was NOT a 1, and none of the dices rolled number 6 twice.
        if (dice1 !== 1 && dice2 !== 1) {
